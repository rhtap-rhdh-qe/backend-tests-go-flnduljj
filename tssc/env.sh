...
export IMAGE_URL=${IMAGE_URL-quay.io/rhtap_qe/backend-tests-go-flnduljj:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/backend-tests-go-flnduljj-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-tssc-tas.apps.rosa.kx-bcfe497250.ba86.p3.openshiftapps.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-tssc-tas.apps.rosa.kx-bcfe497250.ba86.p3.openshiftapps.com}
